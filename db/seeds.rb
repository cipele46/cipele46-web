...
[
  ...
  [ "Poklanjam papigu", 1, 1, 1, 'adSeedImg1.jpg', Ad::STATUS[:active], Ad::TYPES[:supply], "091 555 666", "email@domena.hr"],
  [ "Trebalo bi mi 200 kuna", 2, 1, 20, 'adSeedImg2.jpg', Ad::STATUS[:active], Ad::TYPES[:demand], "091 555 666", "email@domena.hr"],
  [ "Tražim cipele 47", 3, 1, 30, 'adSeedImg3.jpg', Ad::STATUS[:active], Ad::TYPES[:demand], "091 555 666", "email@domena.hr"],
  [ "Poklanjam commodore 64", 1, 1, 1, 'adSeedImg1.jpg', Ad::STATUS[:active], Ad::TYPES[:supply], "091 555 666", "email@domena.hr"],
  [ "Trebalo bi mi 300 kuna", 2, 1, 20, 'adSeedImg2.jpg', Ad::STATUS[:active], Ad::TYPES[:demand], "091 555 666", "email@domena.hr"],
  [ "Tražim zelene papuče", 3, 1, 30, 'adSeedImg3.jpg', Ad::STATUS[:active], Ad::TYPES[:demand], "091 555 666", "email@domena.hr"],
  [ "Poklanjam ženu", 1, 1, 1, 'adSeedImg1.jpg', Ad::STATUS[:active], Ad::TYPES[:supply], "091 555 666", "email@domena.hr"],
  [ "Trebalo bi mi 400 kuna", 2, 1, 20, 'adSeedImg2.jpg', Ad::STATUS[:active], Ad::TYPES[:demand], "091 555 666", "email@domena.hr"],
  [ "Tražim aparat za gašenje požara", 3, 1, 30, 'adSeedImg3.jpg', Ad::STATUS[:active], Ad::TYPES[:demand], "091 555 666", "email@domena.hr"],
  [ "Poklanjam babu", 1, 1, 1, 'adSeedImg1.jpg', Ad::STATUS[:active], Ad::TYPES[:supply], "091 555 666", "email@domena.hr"],
  [ "Trebalo bi mi 500 kuna", 2, 1, 20, 'adSeedImg2.jpg', Ad::STATUS[:active], Ad::TYPES[:demand], "091 555 666", "email@domena.hr"],
  [ "Tražim kunu za pivo", 3, 1, 30, 'adSeedImg3.jpg', Ad::STATUS[:active], Ad::TYPES[:demand], "091 555 666", "email@domena.hr"],
  [ "Poklanjam punicu", 1, 1, 1, 'adSeedImg1.jpg', Ad::STATUS[:active], Ad::TYPES[:supply], "091 555 666", "email@domena.hr"],
  [ "Trebalo bi mi 600 kuna", 2, 1, 20, 'adSeedImg2.jpg', Ad::STATUS[:active], Ad::TYPES[:demand], "091 555 666", "email@domena.hr"],
  [ "Tražim đemper", 3, 1, 30, 'adSeedImg3.jpg', Ad::STATUS[:active], Ad::TYPES[:demand], "091 555 666", "email@domena.hr"],
  [ "Tražim aparat za gašenje požara", 3, 1, 30, 'adSeedImg3.jpg', Ad::STATUS[:active], Ad::TYPES[:demand], "091 555 666", "email@domena.hr"],
  [ "Poklanjam ćukca", 1, 1, 1, 'adSeedImg1.jpg', Ad::STATUS[:active], Ad::TYPES[:supply], "091 555 666", "email@domena.hr"],
  [ "Trebalo bi mi 600 kuna", 2, 1, 20, 'adSeedImg2.jpg', Ad::STATUS[:active], Ad::TYPES[:demand], "091 555 666", "email@domena.hr"],
  [ "Tražim naočale", 3, 1, 30, 'adSeedImg3.jpg', Ad::STATUS[:active], Ad::TYPES[:demand], "091 555 666", "email@domena.hr"],
  [ "Poklanjam kanarinca", 1, 1, 1, 'adSeedImg1.jpg', Ad::STATUS[:active], Ad::TYPES[:supply], "091 555 666", "email@domena.hr"],
  [ "Trebalo bi mi 700 kuna", 2, 1, 20, 'adSeedImg2.jpg', Ad::STATUS[:active], Ad::TYPES[:demand], "091 555 666", "email@domena.hr"],
  [ "Tražim macbook", 3, 1, 30, 'adSeedImg3.jpg', Ad::STATUS[:active], Ad::TYPES[:demand], "091 555 666", "email@domena.hr"]
